...
//         isValid = false;
//         showError(playerName, "Player name is not valid");
//     } else {
//         hideError(playerName);
//     }

//     if(!url.test(playerPhoto)) {
//         isValid = false;
...
//     if(!url.test(playerNationalityflag)) {
//         isValid = false;
...
//     if(!numbers.test(playerRating)) {
//         isValid = false;
//         showError(playerClubLogo, "Enter a valid rating");
//     } else {
//         hideError(playerClubLogo);
//     }
//     return isValid;
...
//     if(!numbers.test(playerPace)) {
//         isValid = false;
//         showError(playerPace, "Enter a valid pace");
//     } else {
//         hideError(playerPace);
//     }

//     if(!numbers.test(playerShooting)) {
//         isValid = false;
//         showError(playerShooting, "Enter a valid shooting");
//     } else {
//         hideError(playerShooting);
//     }

//     if(!numbers.test(playerPassing)) {
//         isValid = false;
//         showError(playerPassing, "Enter a valid passing");
//     } else {
//         hideError(playerPassing);
//     }

//     if(!numbers.test(playerDribbling)) {
//         isValid = false;
//         showError(playerDribbling, "Enter a valid dribbling");
//     } else {
//         hideError(playerDribbling);
//     }

//     if(!numbers.test(playerDefending)) {
//         isValid = false;
//         showError(playerDefending, "Enter a valid deffending");
//     } else {
